...
import { LayoutDashboard, Users, HeartPulse, Settings, LogOut, Calendar, BarChart3, NotebookPen } from 'lucide-react';
...
export function AppSidebar() {
  ...
  const menuItems = [
    ...
    { href: '/ai-notes', label: 'Anotações IA', icon: NotebookPen },
